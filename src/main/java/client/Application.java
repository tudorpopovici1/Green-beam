...
class Application {
    ...
    public static void getTransportationEmissions() {
        ...
        UriComponentsBuilder uriComponentsBuilder = UriComponentsBuilder.fromHttpUrl(url)
                ...
                .queryParam("input_takeaction_ride_my_bike_include_foodemissions", "0,1232")
                .queryParam("input_takeaction_assumption_price_of_gasoline", "4")
                ...
                .queryParam("input_footprint_shopping_food_meat_fish", 0)
                .queryParam("input_footprint_shopping_food_meat_other", 0)
                .queryParam("input_footprint_shopping_food_dairy", 600)
                .queryParam("input_footprint_shopping_food_otherfood", 1300)
                .queryParam("input_footprint_shopping_food_fruitvegetables", 400)
                .queryParam("input_footprint_shopping_food_cereals", 500)
